...
public class LocalizarAvisoCommand implements Command {
    private PrintWriter out;
    private BufferedReader stdIn;
    private ObjectMapper objectMapper;
    private final String token;

    public LocalizarAvisoCommand(PrintWriter out, BufferedReader stdIn, ObjectMapper objectMapper, String token) {
        this.out = out;
        this.stdIn = stdIn;
    ...
    public void execute() throws IOException {
        ...
        SolicitaInformacoesAvisoDTO solicitaInformacoesAvisoDTO = new SolicitaInformacoesAvisoDTO("localizarAviso", token, id);
