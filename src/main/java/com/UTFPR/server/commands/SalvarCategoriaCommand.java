...
public class SalvarCategoriaCommand implements Command {
    ...
    public void execute() throws IOException {
        ...
        try {
            ...
            if(salvarCategoriaDTO.getCategoriaDTO().getId() == 0){
                categoryService.registerCategory(salvarCategoriaDTO.getCategoriaDTO().toCategory());
            ...
            Category oldCategory = categoryService.getCategoryById(salvarCategoriaDTO.getCategoriaDTO().getId());
            Category newCategory = salvarCategoriaDTO.getCategoriaDTO().toCategory();
